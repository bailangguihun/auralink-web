...
export default async function Mojuanjieyu(imageContent) {
  let file = null;
  ...
  const { baseUrl, token, workflowId, uploadUrl } = config.Mojuanjieyu;
  ...
  try {
    console.log('[Mojuanjieyu] 开始调用工作流:', { workflowId, fileId });
