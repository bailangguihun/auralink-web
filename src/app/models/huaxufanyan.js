...
export default async function Huaxufanyan(imageContent) {
  let file = null;
  ...
  const { baseUrl, token, workflowId, uploadUrl } = config.Huaxufanyan;
  ...
  try {
    console.log('[Huaxufanyan] 开始调用工作流:', { workflowId, fileId });
